                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        // Cancel：不在扫描模式 → 返回；在扫描模式 → 也返回 IssuePage（保持 pending）
                        Expanded(
                          child: OutlinedButton(
                            style: OutlinedButton.styleFrom(
                              padding: const EdgeInsets.symmetric(vertical: 14),
                        ...
                        // Continue：
                        // - 非扫描模式：需要 allAvailable 才能进入扫描模式
                        // - 扫描模式：需要 allScanned 才能弹确认并更新为 on_delivery
                        Expanded(
                          child: ElevatedButton(
                            ...
                            onPressed: !_scanMode
                              ...
                              if (ok == true) {
                                ...
                                if (mounted) Navigator.pop(context); // 回 IssuePage
                              } else {
