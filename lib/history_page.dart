...
class HistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 历史记录：completed / rejected
    final historyStream = RequestService.instance.myHistoryNoIndex(kFromWarehouseId);
            ...
            builder: (context, snap) {
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  final requestDateText = _fmtDate(m['requestDate']);
                  final receiveDateText = _fmtDate(m['receiveDate']); // completed 时应有
                  ...
                  return _HistoryCard(
                    ...
                    receiveDateText: receiveDateText,
                    status: status,
                    onTap: docId.isEmpty
                        ? null
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _InfoRow(
                        ...
                        text: 'Receive Date : $receiveDateText',
                      ),
                      const SizedBox(height: 8),

                      // Requester To：放在日期下面，蓝色胶囊
...
/* --------------------------- 状态样式映射（历史常用 completed/rejected） --------------------------- */
...
class _StatusStyle {
  ...
  static _StatusStyle of(String status) {
    switch (status) {
      ...
      case 'pending':
        return const _StatusStyle('Pending', Color(0xFF1976D2)); // 蓝（兜底）
      case 'on_delivery':
        return const _StatusStyle('On Delivery', Color(0xFFFF8C00)); // 橙（兜底）
      default:
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: const [
            Icon(Icons.history_toggle_off_rounded, size: 48, color: Color(0xFFB0B6BF)),
            SizedBox(height: 12),
            Text(
              'No history',
